...
class _HelpPageState extends ConsumerState<HelpPage>
        ...
        Expanded(
          child: filteredFAQs.isEmpty
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) =>
                      _buildFAQItem(filteredFAQs[index]),
                ),
        ),
      ],
    );
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                const Text(
                    'Help ons de app te verbeteren door je feedback te delen.'),
                const SizedBox(height: 16),
                ElevatedButton(
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          const Text(
              'Menutri helpt je gezondere keuzes te maken bij het eten. Ontdek restaurants, bekijk voedingsinformatie en houd je voedingsdoelen bij.'),
          const SizedBox(height: 24),
          Text('Functies',
              style: Theme.of(context).textTheme.titleMedium?.copyWith(
                    fontWeight: FontWeight.bold,
          ...
          Container(
            ...
            child: const Column(
              ...
              children: [
                ...
                SizedBox(height: 8),
                Text('© 2024 Menutri. Alle rechten voorbehouden.'),
              ],
            ),
          ),
        ],
      ...
      child: ListTile(
        ...
        subtitle: Column(
          ...
          children: [
            Text(subtitle,
                style: TextStyle(
                    color: AppColors.mediumBrown, fontWeight: FontWeight.w600)),
  ...
  Widget _buildSocialButton(
    ...
    return Expanded(
      child: OutlinedButton.icon(
        ...
        icon: Icon(icon),
        label: Text(label),
        style: OutlinedButton.styleFrom(foregroundColor: AppColors.mediumBrown),
      ),
    );
  }
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(description, style: TextStyle(color: AppColors.grey)),
              ],
            ),
          ),
        ],
  ...
  Widget _buildLegalLink(String title, VoidCallback onTap) => ListTile(
        title: Text(title),
        trailing: const Icon(Icons.arrow_forward_ios),
        onTap: onTap,
  ...
  Future<void> _launchEmail(String email) async {
    final Uri emailUri =
        Uri(scheme: 'mailto', path: email, query: 'subject=Menutri Support');
  ...
  void _openLiveChat() {
    showDialog(
        ...
        builder: (context) => AlertDialog(
              ...
              content: const Text('Live chat is momenteel niet beschikbaar.'),
              actions: [
                TextButton(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          DropdownButtonFormField<String>(
            ...
            decoration: const InputDecoration(
                labelText: 'Type feedback', border: OutlineInputBorder()),
